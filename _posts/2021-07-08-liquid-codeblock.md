...
"<code class="language-plaintext highlighter-rouge">::before "{%raw%}" ::after</code> 와 <code class="language-plaintext highlighter-rouge">::before "{%endraw%}" ::after</code>" 로 코드블럭을 감싸면   
